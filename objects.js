...
createPlant("rose ", true, "layered ", "green ", "red/pink", "red/link and layered", "Two inches of water a week (4 to 5 gallons) ", "3/10" )
...
function addPlantToEstate(estate, plant) {
  ...
  else estate.slopePlanters.push(plant)
...
function describePlant(plant) {
  // Your Code Here!
  let description = "A " + plant.type + " is a plant with " + plant.leafColor + " and " + plant.flowerColor + " color to it. " +  " leaves. It has " + plant.flowerDescription + "."
